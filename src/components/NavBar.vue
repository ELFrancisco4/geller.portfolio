    ...
    <nav class="nav">
      ...
      <div class="right" print:op0>
        ...
        <RouterLink to="/demos" title="Demos">
          <span class="lt-md:hidden">Showcases</span>
        ...
        <a href="https://twitter.com/Elixir_js" target="_blank" title="Twitter" class="lt-md:hidden">
          <feather-twitter />
        </a>
        <a href="https://github.com/Geller99" target="_blank" title="GitHub" class="lt-md:hidden">
